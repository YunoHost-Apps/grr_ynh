...
[![Integration level](https://apps.yunohost.org/badge/integration/grr)](https://ci-apps.yunohost.org/ci/apps/grr/)
![Working status](https://apps.yunohost.org/badge/state/grr)
![Maintenance status](https://apps.yunohost.org/badge/maintained/grr)
